...
import TrustedBy from './components/TrustBadges';
...
const Logo: React.FC = () => (
  <div className="flex items-center space-x-2">
    ...
    <span className="font-bold text-2xl text-[#1C1C1C] dark:text-gray-100">FinCoach</span>
  </div>
);
...
const App: React.FC = () => {
  ...
  const Header = () => (
    <header className="bg-[#F9F9F7]/80 dark:bg-gray-900/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800">
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#who-its-for" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Who it's for</a>
          <a href="#pricing" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Pricing</a>
          <a href="#learning-hub" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Learning Hub</a>
        </div>
  ...
  const FinalCTA = () => (
    <section id="final-cta" className="bg-[#EAF3E8] dark:bg-gray-800 py-20 scroll-mt-20">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-[#1C1C1C] dark:text-white">
  ...
  const Footer = () => (
    <footer className="bg-[#F9F9F7] dark:bg-gray-900 py-12 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left space-y-6 md:space-y-0">
          <div className="flex space-x-6 text-gray-500 dark:text-gray-400">
            ...
            <a href="#" className="hover:text-gray-800 dark:hover:text-white">Contact Us</a>
          </div>
          <div className="flex space-x-6 text-gray-500 dark:text-gray-400">
            <a href="#" className="hover:text-gray-800 dark:hover:text-white"><TwitterIcon /></a>
            <a href="#" className="hover:text-gray-800 dark:hover:text-white"><InstagramIcon /></a>
            <a href="#" className="hover:text-gray-800 dark:hover:text-white"><FacebookIcon /></a>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F7] text-[#1C1C1C] dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300">
      <Header />
      <main>
        <Hero />
        <HowItWorks />
