  ...
  return (
    <div className="min-h-screen bg-gray-50 text-[#1A1A1A]">
      ...
      <main className="pb-24">
        {/* Hero Section */}
        <section className="text-center px-6 py-12 md:py-16 bg-white">
            <img src="https://picsum.photos/seed/mentor/200" alt="Priya Didi" className="w-40 h-40 rounded-full mx-auto shadow-xl border-4 border-white" />
            <h1 className="text-4xl md:text-5xl font-extrabold text-[#1A1A1A] mt-6">
                Meet Priya Didi
            </h1>
            <p className="mt-4 text-xl md:text-2xl text-[#2A6F6F] max-w-2xl mx-auto">
        ...
        {/* Pricing Section */}
        <section className="py-16 md:py-24 px-6 bg-teal-50/50">
            <div className="max-w-2xl mx-auto text-center">
                 <h2 className="text-3xl md:text-4xl font-bold text-center text-[#1A1A1A] mb-8">
                    Simple, Transparent Pricing
                </h2>
                <div className="bg-white p-10 rounded-xl shadow-xl">
                    <p className="text-5xl font-extrabold text-[#1A1A1A]">₹79</p>
                    <p className="text-xl text-gray-600">per week</p>
                    <p className="mt-4 text-xl font-bold text-green-600">Your first week is completely free!</p>
                    <p className="mt-4 text-gray-600">Cancel anytime. No hidden fees, no pressure. The free coaching is always available if you decide it's not for you.</p>
                     <a
                        href={WHATSAPP_LINK}
                        target="_blank"
