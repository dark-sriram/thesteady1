      ...
      <div className="p-6 md:p-12">
        ...
        <main className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-xl text-gray-700 dark:text-gray-300 leading-relaxed bg-white dark:bg-gray-800 p-8 rounded-lg shadow-sm border dark:border-gray-700">
            <h2 className="text-3xl font-bold text-[#1A1A1A] dark:text-white">What is a Mutual Fund?</h2>
            <p>
            ...
            <h2 className="text-3xl font-bold text-[#1A1A1A] dark:text-white">Why are they good for beginners?</h2>
