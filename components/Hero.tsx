    ...
    <section ref={ref} id="hero" className={`container mx-auto px-6 py-20 md:py-32 section-animate ${isVisible ? 'is-visible' : ''}`}>
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="text-center md:text-left">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#1C1C1C] dark:text-white leading-tight animate-child animate-child-1">
            Your personal financial coach, in your pocket
          </h1>
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-lg mx-auto md:mx-0 animate-child animate-child-2">
        ...
        <div className="flex justify-center animate-child animate-child-2">
          <img src="https://images.unsplash.com/photo-1554224155-1696413565d3?q=80&w=2070&auto=format&fit=crop" alt="Phone with messaging app" className="rounded-2xl shadow-xl max-w-sm w-full" />
        </div>
      </div>
    </section>
  );
